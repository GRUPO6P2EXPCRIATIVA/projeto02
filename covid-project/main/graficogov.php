...
<div class="alert alert-success" role="alert"><h1 id="h1home">Dados da Covid-19 no Brasil Fonte: Governo Brasileiro</h1></div>
...
new Chart(document.getElementById("line-chart"), {
  ...
  data: {
    ...
    datasets: [{ 
        data: [1,7543,86406,515100,828810],
        label: "Casos",
        borderColor: "#3e95cd",
  ...
  options: {
    title: {
      display: true,
      text: 'Casos de coronavírus no Brasil'
    }
  }
});
</script>
